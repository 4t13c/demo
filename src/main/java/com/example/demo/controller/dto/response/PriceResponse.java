...
public class PriceResponse {
    ...
    public PriceResponse setBrandId(Integer brandId) {
    ...
    public PriceResponse setStartDate(LocalDateTime startDate) {
    ...
    public PriceResponse setEndDate(LocalDateTime endDate) {
    ...
    public PriceResponse setPriceListId(Integer priceListId) {
    ...
    public PriceResponse setProductId(Integer productId) {
    ...
    public PriceResponse setPriority(Integer priority) {
    ...
    public PriceResponse setPrice(double price) {
        this.price = price;
        return this;
    }
    ...
    public PriceResponse setCurr(String curr) {
        this.curr = curr;
        return this;
    }
